...
Forty-three pages about a shipyard that does not exist, built to find out how
much a browser will do for you before you reach for JavaScript — plus one more
that a Scala program writes for itself.

**Forty-one of the forty-three have no script in them at all.** They still
...
1. **`:has()` is required.** Thirty-eight of the pages depend on it. On a
