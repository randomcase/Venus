...
Forty-six pages about a shipyard that does not exist, built to find out how
much a browser will do for you before you reach for JavaScript — plus one more
that a Scala program writes for itself.

**Forty-four of the forty-six have no script in them at all.** They still
...
1. **`:has()` is required.** Forty-one of the pages depend on it. On a
