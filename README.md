...
Forty-two pages about a shipyard that does not exist, built to find out how
much a browser will do for you before you reach for JavaScript — plus one more
that a Scala program writes for itself.

**Forty of the forty-two have no script in them at all.** They still
...
1. **`:has()` is required.** Thirty-seven of the pages depend on it. On a
