...
export const RULES = {
  ...
  coven: { ...DOCKET, intervalDays: 183, quorum: 2, of: 3, proposalEvery: 3, signChance: 12, deskLimit: 40, staleAfter: 183 },
};
export const NOTES = {
